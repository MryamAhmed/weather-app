...
class WeatherModel{
   ...
   WeatherModel({ required this.data , required this.maxTemp, required this.minTemp,required this.temp,required this.weatherStateName});
  ...
  @override
  String toString(){
    return 'temp = $temp  maxTemp =$maxTemp  minTemp=$minTemp weatherStateName=$weatherStateName data=$data ';
  }
